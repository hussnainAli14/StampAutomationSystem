...
import { paymentToast } from "../ApiService/ToastDisplay";
import { ToastContainer } from "react-toastify";
import { addTransaction } from "../ApiService/Mint";
  ...
  return (
    <div className="row payment">
      <div className="col-lg-4 col-md-6 payment-method ">
        <h3 className="fw-bold mt-4 mb-3 text-center">Select Payment Method</h3>
        <br />
        <input
        ...
        />
        <label
          className="form-check-label fs-5 mx-2 mb-3"
        ...
        />
        <label
          className="form-check-label fs-5 mx-2 mb-3 mt-1"
          for="flexRadioDefault1"
        >
      ...
      <div className="col-lg-4 col-md-6 account-info offset-1">
        ...
        <input
          className=" payment-input"
          type="text"
          placeholder="Stamp Agreement Fee"
          required
        />
        <label className="mt-2 payment-label">Stamp Agreement Fee</label>
        <br />
        <button className="btn rounded-pill mt-4 ps-5 pe-5 pt-2 pb-2 bg-dark text-white payment-btn"
        onClick={
          ()=>{
            paymentToast()
            addTransaction()
